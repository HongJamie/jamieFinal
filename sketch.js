...
function preload() {
  ...
  handImg = loadImage(
    "hand.png",
    () => console.log("loaded hand.png"),
    (err) => console.error("FAILED hand.png", err)
  );

  fretboardImg = loadImage(
    "fretboard.jpg",
    () => console.log("loaded fretboard.jpg"),
    (err) => console.error("FAILED fretboard.jpg", err)
  );

  // Acoustic sounds
  sounds.C = loadSound("sounds/c.mp3",
    () => console.log("loaded sounds/c.mp3"),
    (err) => console.error("FAILED sounds/c.mp3", err)
  );
  sounds.G = loadSound("sounds/g.mp3",
    () => console.log("loaded sounds/g.mp3"),
    (err) => console.error("FAILED sounds/g.mp3", err)
  );
  sounds.D = loadSound("sounds/d.mp3",
    () => console.log("loaded sounds/d.mp3"),
    (err) => console.error("FAILED sounds/d.mp3", err)
  );
  sounds.Em = loadSound("sounds/em.mp3",
    () => console.log("loaded sounds/em.mp3"),
    (err) => console.error("FAILED sounds/em.mp3", err)
  );
  sounds.Am = loadSound("sounds/am.mp3",
    () => console.log("loaded sounds/am.mp3"),
    (err) => console.error("FAILED sounds/am.mp3", err)
  );
  sounds.E = loadSound("sounds/e.mp3",
    () => console.log("loaded sounds/e.mp3"),
    (err) => console.error("FAILED sounds/e.mp3", err)
  );
  sounds.A = loadSound("sounds/a.mp3",
    () => console.log("loaded sounds/a.mp3"),
    (err) => console.error("FAILED sounds/a.mp3", err)
  );
  sounds.F = loadSound("sounds/f.mp3",
    () => console.log("loaded sounds/f.mp3"),
    (err) => console.error("FAILED sounds/f.mp3", err)
  );

  // Electric sounds
  electricSounds.D1 = loadSound("electricSounds/d1.mp3",
    () => console.log("loaded electricSounds/d1.mp3"),
    (err) => console.error("FAILED electricSounds/d1.mp3", err)
  );
  electricSounds.E5 = loadSound("electricSounds/e5.mp3",
    () => console.log("loaded electricSounds/e5.mp3"),
    (err) => console.error("FAILED electricSounds/e5.mp3", err)
  );
  electricSounds.F5 = loadSound("electricSounds/f5.mp3",
    () => console.log("loaded electricSounds/f5.mp3"),
    (err) => console.error("FAILED electricSounds/f5.mp3", err)
  );
  electricSounds.G5 = loadSound("electricSounds/g5.mp3",
    () => console.log("loaded electricSounds/g5.mp3"),
    (err) => console.error("FAILED electricSounds/g5.mp3", err)
  );
  electricSounds.A5 = loadSound("electricSounds/a5.mp3",
    () => console.log("loaded electricSounds/a5.mp3"),
    (err) => console.error("FAILED electricSounds/a5.mp3", err)
  );
  electricSounds.C2 = loadSound("electricSounds/c2.mp3",
    () => console.log("loaded electricSounds/c2.mp3"),
    (err) => console.error("FAILED electricSounds/c2.mp3", err)
  );
}
